...
<template>
  <section class="min-h-screen bg-[#0f0f12] text-gray-100 px-6 py-8 max-w-6xl mx-auto">
    ...
    <header class="mb-8">
      ...
      <p class="text-gray-400 mt-1">Suivez vos candidatures et activités.</p>
    </header>

    <!-- Statistiques -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
      <div class="bg-[#15151b] p-6 rounded-lg shadow-md text-center">
        <p class="text-4xl font-bold text-blue-400">{{ stats.totalCandidatures }}</p>
        <p class="text-gray-300 mt-1"> Stages en attente</p>
      </div>
      <div class="bg-[#15151b] p-6 rounded-lg shadow-md text-center">
        <p class="text-4xl font-bold text-green-400">{{ stats.candidaturesAcceptees }}</p>
        <p class="text-gray-300 mt-1"> Stages en cours</p>
      </div>
      <div class="bg-[#15151b] p-6 rounded-lg shadow-md text-center">
        <p class="text-4xl font-bold text-yellow-400">{{ stats.candidaturesEnAttente }}</p>
        <p class="text-gray-300 mt-1">Stages terminés</p>
      </div>
    </div>
