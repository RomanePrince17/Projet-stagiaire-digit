<template>
  <div class="min-h-screen text-white p-6">
    <h1 class="text-2xl font-bold mb-6">Demandes de stage rejetées</h1>
        ...
        <div class="p-4">
          ...
          <div class="text-sm space-y-1">
            ...
            <p><span class="font-medium">Statut :</span>
              <span class="text-red-400">{{ demande.statut }}</span>
            </p>
          </div>

          <!-- Actions (uniquement voir pour les refusés) -->
...
const demandesFiltrees = computed(() => {
  return demandes.value.filter(d => {
    ...
    const statutOk = d.statut === 'rejeté'
